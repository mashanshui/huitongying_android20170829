...
public class ShopCenterSubmitNewActivity extends BaseActivity implements View.OnClickListener {
   ...
   public static void startShopCenterSubmitNewActivity(Context context, int flag) {
      Intent intent = new Intent(context, ShopCenterSubmitNewActivity.class);
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.activity_shop_center_submit_new);
...
//                ShopTypeActivity.startShopTypeActivity(this,SHOP_TYPE);
         ...
         case R.id.tv_shop_sys_protocol://用户协议
            ShopInfoActivity.startShopInfoActivity(ShopCenterSubmitNewActivity.this, "", "2");
            break;
...
//                }
   ...
   private void initDialog() {
      ...
      helpButton.setOnClickListener(new View.OnClickListener() {
         @Override
         public void onClick(View v) {
            RegActivity.startRegActivity(ShopCenterSubmitNewActivity.this, RegActivity.EDIT_PAY_PASSWORD);
         }
      });
      cancelButton.setOnClickListener(new View.OnClickListener() {
         @Override
      ...
      httpTool.post(shopAddRequestObject, URLConfig.APPLY_SHOP, new HttpTool.HttpCallBack<ShopAddResponseObject>() {
         ...
         public void onSuccess(ShopAddResponseObject o) {
            ...
            if (TextUtils.equals("0", isPayDone)) {//未支付完成
               if (payType == WECHAT_PAY) {
                  if (ThirdPartyClient.isWeixinAvilible(ShopCenterSubmitNewActivity.this)) {
         ...
         case WECHAT_PAY:
            ...
            httpTool.post(weixinOrderAddRequestObject, URLConfig.ORDER_WECHAT_PAY, new HttpTool.HttpCallBack<WeixinOrderAddResponseObject>() {
               ...
               public void onSuccess(WeixinOrderAddResponseObject o) {
                  ...
                  WXPayTool wxPayTool = new WXPayTool(ShopCenterSubmitNewActivity.this, weiXin.getParam().getAppid());
...
//                payAlertTip.show();
   ...
   private void selectAddress() {
      MyCityPicker cityPicker = new MyCityPicker.Builder(ShopCenterSubmitNewActivity.this)
            .textSize(14)
            .title("地址选择")
