...
public class yixiajiaAdapter extends AppAdapter<ProductListResponseParam> {
   private HttpTool httpTool;
   private BitmapUtils bitmapUtils;

   public yixiajiaAdapter(List<ProductListResponseParam> list, Context context, BitmapUtils bitmapUtils) {
      super(list, context);
   ...
   public View createItemView(int position, View converView, ViewGroup parent) {
      ...
      if (converView == null) {
         //找控件
         converView = LayoutInflater.from(context).inflate(R.layout.adapter_yixiajia, null, false);
...
/*            intent_jifen.putExtra(EditShangpinManageActivity.CATEGORYID, newsRows.getCategoryId());
            ...
            intent_jifen.putExtra(EditShangpinManageActivity.STATE, "1");
       ...
       /*     final Dialog dialog1 = new Dialog(context);
            ...
            dialog1.setConfirmClick(new DialogInterface.OnClickListener() {
               ...
               public void onClick(DialogInterface dialog, int which) {
                  Toast.makeText(context, "修改该商品", Toast.LENGTH_LONG).show();
         ...
         public void onClick(View v) {
            ...
            dialog1.setConfirmClick(new DialogInterface.OnClickListener() {
               ...
               public void onClick(DialogInterface dialog, int which) {
                  ...
                  productEditRequestParam.setStatus("0"); //status	上架或下架 0 上架 1下架
                  ...
                  httpTool.post(productEditRequestObject, URLConfig.SHOP_EDIT, new HttpTool.HttpCallBack<ResponseBaseObject>() {
                     ...
                     public void onSuccess(ResponseBaseObject o) {
                        list.remove(newsRows);
                        notifyDataSetChanged();
                        Toast.makeText(context, "已上架该商品", Toast.LENGTH_LONG).show();
                     }
