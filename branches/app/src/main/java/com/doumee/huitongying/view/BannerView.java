...
public class BannerView extends FrameLayout {
    ...
    public BannerView setAdapter(BannerPagerAdapter adapter) {
        mAdapter = adapter;
    ...
    public BannerView setOnItemClickListener(BannerPagerAdapter.onItemClickListener l) {
    ...
    public BannerView setDot(int... dots) {
        mDot[0] = dots[0];
        mDot[1] = dots[1];
