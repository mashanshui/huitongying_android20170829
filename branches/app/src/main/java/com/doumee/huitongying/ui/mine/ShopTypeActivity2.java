...
public class ShopTypeActivity2 extends BaseActivity {
   ...
   public static void startShopTypeActivity(Activity context, int requestCode) {
      Intent intent = new Intent(context, ShopTypeActivity2.class);
   ...
   private class ExpandableListViewAdapter extends BaseExpandableListAdapter {
      ...
      public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
         ...
         if (null == convertView) {
            ...
            convertView = View.inflate(ShopTypeActivity2.this, R.layout.shop_type_child_textview, null);
            holdView.checkBox = (TextView) convertView.findViewById(R.id.tv_child);
            convertView.setTag(holdView);
         } else {
            holdView = (ShopTypeActivity2.ChildHoldView) convertView.getTag();
         }
         ...
         holdView.checkBox.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
      ...
      public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
         ...
         if (convertView == null) {
            ...
            convertView = View.inflate(ShopTypeActivity2.this, R.layout.shop_type_group, null);
            groupHoldView.textView = (TextView) convertView.findViewById(R.id.group);
            convertView.setTag(groupHoldView);
         } else {
            groupHoldView = (ShopTypeActivity2.GroupHoldView) convertView.getTag();
         }
