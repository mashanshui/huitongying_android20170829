package com.huixiangshenghuo.app.activity.integralmall;
...
import com.huixiangshenghuo.app.adapter.integralmall.LatestShelvesAdapter;
...
public class IntegralGoodsListActivity extends BaseActivity implements View.OnClickListener, RefreshLayout.ILoadListener, RefreshLayout.OnRefreshListener {
    ...
    public static void startGoodsListActivity(Context context, String parentId, String parentName) {
        Intent intent = new Intent(context, IntegralGoodsListActivity.class);
...
//            }
    ...
    private void initBitmapParames() {
        ...
        re_adapter = new LatestShelvesAdapter(arrlist, IntegralGoodsListActivity.this, bitmapUtils);
...
//            ProductsDetailsActivity.startProductsDetailsActivity(GoodsListActivity.this, arrlist.get(position).getProId());
                ...
                ProductsDetailsNewActivity.startProductsDetailsNewActivity(IntegralGoodsListActivity.this, arrlist.get(position).getProId());
...
//            SearchProductActivity.startSearchProductActivity(GoodsListActivity.this, 0);
                SearchProductNewActivity.startSearchProductNewActivity(IntegralGoodsListActivity.this, 0);
                break;
        }
    }
    ...
    private void request() {
        ...
        object.getParam().setType("2");
        object.getParam().setStatus("0");
