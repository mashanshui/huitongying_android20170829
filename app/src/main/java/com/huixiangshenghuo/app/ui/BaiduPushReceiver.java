...
import com.huixiangshenghuo.app.comm.app.APPTool;
...
public class BaiduPushReceiver extends PushMessageReceiver {
    ...
    public void onNotificationArrived(Context context, String title,
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences(CustomConfig.APP_INFO, Activity.MODE_PRIVATE);
        int count = sharedPreferences.getInt(CustomConfig.MESSAGE_COUNT,0);
        count++;
        sharedPreferences.edit().putInt(CustomConfig.MESSAGE_COUNT,count).commit();
    ...
    public void onNotificationClicked(Context context, String title,
        ...
        if (!TextUtils.isEmpty(customContentString)) {
         ...
         manager.cancelAll();
        if (!APPTool.isAppRunningForeground(context)){
            SharedPreferences sharedPreferences = context.getSharedPreferences(CustomConfig.APP_INFO, Activity.MODE_PRIVATE);
            sharedPreferences.edit().putInt(CustomConfig.APP_IS_RUNNING,0).commit();
            //在后台运行
