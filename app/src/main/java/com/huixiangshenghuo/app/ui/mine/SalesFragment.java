...
public class SalesFragment extends android.support.v4.app.Fragment implements RefreshLayout.ILoadListener, RefreshLayout.OnRefreshListener {
...
//   private List<City> list;
   ...
   public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      ShopSelesStatic.setShopSeles_static("0");
      initView();
      return view;
   ...
   private void initView() {
      refreshLayout = (RefreshLayout) view.findViewById(R.id.refresh_sales);
      listView = (ListView) view.findViewById(R.id.lv_sales);
      initBitmapParames();
      initData();
      //构建适配器
      adapter = new SalesAdapter(arrlist, getActivity(), bitmapUtils);
   ...
   public void onResume() {
      super.onResume();
      if (ShopSelesStatic.getShopSeles_static().equals("1")) {
         page = 1;
         refreshLayout.setRefreshing(true);
         request();
         ShopSelesStatic.getShopSeles_static().equals("0");
      }
   }
...
/*      list = new ArrayList<City>();
      City city1 = new City("煲仔饭", "库存128", "月销3620", R.mipmap.icon, "￥38");
      City city2 = new City("煲仔饭", "库存128", "月销3620", R.mipmap.icon, "￥38");
      City city3 = new City("煲仔饭", "库存128", "月销3620", R.mipmap.icon, "￥38");
      City city4 = new City("煲仔饭", "库存128", "月销3620", R.mipmap.icon, "￥38");
      City city5 = new City("煲仔饭", "库存128", "月销3620", R.mipmap.icon, "￥38");
      City city6 = new City("煲仔饭", "库存128", "月销3620", R.mipmap.icon, "￥38");
      City city7 = new City("煲仔饭", "库存128", "月销3620", R.mipmap.icon, "￥38");
      City city8 = new City("煲仔饭", "库存128", "月销3620", R.mipmap.icon, "￥38");
      City city9 = new City("煲仔饭", "库存128", "月销3620", R.mipmap.icon, "￥38");
      list.add(city1);
      list.add(city2);
      list.add(city3);
      list.add(city4);
   ...
   private void request() {
      ...
      productListRequestObject.getParam().setStatus("0");//type	查询类别	是	Char(1)	商品类型：0 销售中 1已下架
